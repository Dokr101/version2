...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['process_payment'])) {
    ...
    header("Location: /version2/hotel staff/staff_payments.php");
    exit();
}
    ...
    <div class="main-content">
        ...
        <aside class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li><a href="/version2/hotel staff/staff_payments.php" class="active"><i class="fas fa-credit-card"></i> Process Payments</a></li>
